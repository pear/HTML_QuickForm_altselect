--TEST--
18.phpt: Test singular mode, with new 'textarea' other
--FILE--
<?php
...
$select->setIncludeOther('textarea');
echo $select->toHtml();
?>
--EXPECTREGEX--
...
\<label style\="vertical-align: top;" for\="qf_([0-9a-z]+)"\>If other please specify:\<\/label\> \<textarea id\="qf_\5" name\="test_qf_other"\>\<\/textarea\>
\<script type\="text\/javascript"\>
\/\/\<\!\[CDATA\[
