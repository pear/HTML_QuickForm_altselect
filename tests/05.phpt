--TEST--
5.phpt: Test singular mode with other, setting a value
--FILE--
<?php
...
\<input name\="test" value\="b" type\="radio" id\="qf_([0-9a-z]+)" onclick\="_qf_altselect_disableElement\(this\.form\.elements\[this\.name \+ '_qf_other'\],true\);" checked\="checked" \/\>\<label for\="qf_\2"\>B\<\/label\>\<br \/\>
...
\<script type\="text\/javascript"\>
\/\/\<\!\[CDATA\[
_qf_altselect_disableElement\(document\.getElementById\('qf_\5'\),true\);
\/\/\]\]\>
\<\/script\>
